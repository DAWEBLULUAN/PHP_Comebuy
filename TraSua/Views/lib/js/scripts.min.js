...
$(function(){"use strict";$("#my-menu").mmenu({extensions:["theme-dark","border-offset","fx-listitems-slide","listview-huge","pagedim-black"],navbar:{title:"<img src='img/icons/comebuy-logo1.png'> COMEBUY"}});$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active"),$("#my-menu").css("display","block")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active"),$("#my-menu").css("display","none")}),$(".made_with_love").arctext({radius:140}),$(".angle").on("click",function(e){e.preventDefault();var i=$(this).attr("href"),n=$(i).offset().top;$("body, html").animate({scrollTop:n},1500)}),$(".menu").on("click",'a[href = "#reserve"]',function(e){e.preventDefault();var i=$(this).attr("href"),n=$(i).offset().top;$("body, html").animate({scrollTop:n},1500)}),$(".menu").on("click",'a[href = "#event"]',function(e){e.preventDefault();var i=$(this).attr("href"),n=$(i).offset().top;$("body, html").animate({scrollTop:n},1500)}),$(".input-group > input").on("focus",function(){$(this).siblings(".underline").css({width:"100%"})}),$(".input-group > input").on("blur",function(){$(".underline").css({width:"0"})}),$("#datepicker").datepicker(),$(".blog_calendar").datepicker(),$("#timepicker").timepicker(),$(".filter a[href = '#medium']").on("click",function(){$(".price, .price_small").fadeOut(500),$(".price_medium").fadeIn(500).css("display","inline-block")}),$(".filter a[href = '#large']").on("click",function(){$(".price_medium, .price_small").fadeOut(500),$(".price").fadeIn(500).css("display","inline-block")}),$(".filter a[href = '#small']").on("click",function(){$(".price, .price_medium").fadeOut(500),$(".price_small").fadeIn(500).css("display","inline-block")}),$(".filter a[href = '#medium_tea']").on("click",function(){$(".price_tea, .price_small_tea").fadeOut(500),$(".price_medium_tea").fadeIn(500).css("display","inline-block")}),$(".filter a[href = '#large_tea']").on("click",function(){$(".price_medium_tea, .price_small_tea").fadeOut(500),$(".price_tea").fadeIn(500).css("display","inline-block")}),$(".filter a[href = '#small_tea']").on("click",function(){$(".price_tea, .price_medium_tea").fadeOut(500),$(".price_small_tea").fadeIn(500).css("display","inline-block")});$(".owl-carousel").owlCarousel({items:1,loop:!0,margin:500,nav:!1,dots:!0,smartSpeed:1e3}),$(".demo-link-icon.grey").on("click",function(){$(".demo-bar").remove()})});